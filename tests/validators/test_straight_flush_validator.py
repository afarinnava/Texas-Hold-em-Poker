...
class StraightFlushValidatorTest(unittest.TestCase):
    def test_determines_that_there_are_not_firve_consecutive_cards_with_the_same_suit(self):
        cards = [
    ...
    def test_determines_that_there_are_firve_consecutive_cards_with_the_same_suit(self):
        cards = [
            Card(rank="3", suit="Clubs"),
            Card(rank="4", suit="Clubs"),
            Card(rank="5", suit="Clubs"),
    ...
    def test_returns_the_firve_consecutive_cards_with_the_same_suit(self):
